...
class BrochureFormController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $section = [
            3 =>[
                'page2' => '<h2 class="uk-h3 uk-text-bold uk-margin-remove-bottom">BIS/CRS Registration: Mandatory Before Export to India</h2>
                ...
                <h2 class="uk-h3 uk-text-bold uk-margin-remove-bottom">Products Requiring BIS/CRS Registration for Export to India</h2>
                ...
                'page3' => '<h2 class="uk-h3 uk-text-bold uk-margin-remove-bottom">BIS/CRS Registration Procedure</h2>
                ...
                <h2 class="uk-h3 uk-text-bold uk-margin-remove-bottom">BIS/CRS Registration Required Documents</h2>
                ...
                <p class="uk-h4 uk-text-justify uk-margin-remove-top uk-margin-remove-bottom">If applicable, a report detailing the findings of the factory inspection conducted by BIS authorities.</p>
                ...
                <h2 class="uk-h3 uk-text-bold uk-margin-remove-bottom">BIS/CRS Registration Timeline</h2>
                ...
                <h2 class="uk-h3 uk-text-bold uk-margin-remove-bottom">BIS/CRS Registration Costing</h2>
            ...
            4 => [
                'page2' => '<h2 class="uk-h3 uk-text-bold uk-margin-remove-bottom">BIS/ISI Certification: Mandatory Before Export to India</h2>
                ...
                market.<p>
                <h2 class="uk-h3 uk-text-bold uk-margin-remove-bottom">Products Requiring BIS/ISI Certification for Export to India</h2>
                <p class="uk-h4 uk-text-justify uk-margin-remove-top uk-margin-remove-bottom">
                ...
                'page3' => '<h2 class="uk-h3 uk-text-bold uk-margin-remove-bottom">BIS/ISI Certification Procedure</h2>
                <p class="uk-h4 uk-text-justify uk-margin-remove-top uk-margin-remove-bottom">
                ...
                <h2 class="uk-h3 uk-text-bold uk-margin-remove-bottom">BIS/ISI Certification Required Documents</h2>
                <p class="uk-h4 uk-text-justify uk-margin-remove-top uk-margin-remove-bottom">                
                ...
                <h2 class="uk-h3 uk-text-bold uk-margin-remove-bottom">BIS/ISI Certification Timeline</h2>
                <p class="uk-h4 uk-text-justify uk-margin-remove-top uk-margin-remove-bottom">
                Approximately: 5-6 months</p>
                
                <h2 class="uk-h3 uk-text-bold uk-margin-remove-bottom">BIS/ISI Certification Costing<h2>
                <p class="uk-h4 uk-text-justify uk-margin-remove-top uk-margin-remove-bottom">
                As per government guidelines, the fee for BIS/ISI Certification is approximately INR 40,000.</p>
                <p class="uk-h4 uk-text-justify uk-margin-remove-top uk-margin-remove-bottom">
            ...
            5 => [
                'page2' => '<h2 class="uk-h3 uk-text-bold uk-margin-remove-bottom">WPC ETA Approval: Mandatory Before Export to India</h2>
                ...
                <h2 class="uk-h3 uk-text-bold uk-margin-remove-bottom">Products Requiring WPC ETA Approval for Export to India<strong><br></strong></h2>
                ...
                'page3' => '<h2 class="uk-h3 uk-text-bold uk-margin-remove-bottom">WPC ETA Approval Procedure<strong><br></strong></h2>
                ...
                <h2 class="uk-h3 uk-text-bold uk-margin-remove-bottom">WPC ETA Approval Required Documents<strong><br></strong></h2>
                ...
                <h2 class="uk-h3 uk-text-bold uk-margin-remove-bottom"><strong>&nbsp;</strong></h2>
                ...
                <h3 class="uk-h4 uk-text-bold uk-margin-remove-bottom"><strong>&nbsp;</strong></h3>
                <h3 class="uk-h4 uk-text-bold uk-margin-remove-bottom">Declaration of Conformity</h3>
                ...
                <h2 class="uk-h3 uk-text-bold uk-margin-remove-bottom">WPC ETA Approval Timeline</h2>
                ...
                <h2 class="uk-h3 uk-text-bold uk-margin-remove-bottom">WPC ETA Approval Costing</h2>
            ...
            6 => [
                'page2' => '<h2 class="uk-h3 uk-text-bold uk-margin-remove-bottom">TEC Certification: Mandatory Before Export to India</h2>
                ...
                <h2 class="uk-h3 uk-text-bold uk-margin-remove-bottom">Products Requiring TEC Certification for Export to India</h2>
                ...
                'page3' => '<h2 class="uk-h3 uk-text-bold uk-margin-remove-bottom">TEC Certification Procedure</h2>
                ...
                <h2 class="uk-h3 uk-text-bold uk-margin-remove-bottom">TEC Certification Required Documents</h2>
                ...
                <h2 class="uk-h3 uk-text-bold uk-margin-remove-bottom">TEC Certification Timeline</h2>
                <p class="uk-h4 uk-text-justify uk-margin-remove-top uk-margin-remove-bottom">Standard Timeline: 30 to 60 working days</p>
                <h2 class="uk-h3 uk-text-bold uk-margin-remove-bottom">TEC Certification Costing</h2>
