...
CREATE TABLE `blog_categories` (
  `blog_category_id` bigint unsigned NOT NULL AUTO_INCREMENT,
  ...
  `blog_category_description` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `blog_categories` VALUES (1,'Test blog category','test-blog-category','<p>Test blog category</p>','Test blog category','Test blog category','Test blog category','2023-11-17 02:09:22','2023-11-17 02:17:53',NULL);
...
INSERT INTO `blogs` VALUES (1,'Test blog','test-blog',NULL,9,'Electronic games (video) - BIS/CRS Registration','<p>Test blog</p>','Test blog','Test blog','Test blog','2023-11-17 03:10:15','2023-11-17 03:10:15',NULL),(2,'Test blog','test-blog',1,9,'BIS / CRS Registration','<p>Test blog</p>','Test blog',NULL,'Test blog','2023-11-17 03:15:21','2023-11-17 03:27:42',NULL);
...
CREATE TABLE `clients` (
  ...
  `client_slug` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `media_id` bigint unsigned NOT NULL,
  `img_alt` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `client_content` text COLLATE utf8mb4_unicode_ci,
  `client_rating` int DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`client_id`),
  UNIQUE KEY `clients_client_slug_unique` (`client_slug`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `documents` VALUES (1,'sample-1.pdf','documents/sample-1-1700124172.pdf','text/plain',15,'2023-11-16 03:12:52','2023-11-16 03:12:52',NULL),(2,'sample-1.pdf','documents/sample-1-1700124219.pdf','text/plain',15,'2023-11-16 03:13:39','2023-11-16 03:13:39',NULL),(3,'sample-1.pdf','documents/sample-1-1700124476.pdf','text/plain',15,'2023-11-16 03:17:56','2023-11-16 03:17:56',NULL),(4,'sample-1.pdf','documents/sample-1-1700124636.pdf','text/plain',15,'2023-11-16 03:20:36','2023-11-16 03:20:36',NULL);
...
INSERT INTO `migrations` VALUES (1,'2014_10_12_000000_create_users_table',1),(2,'2014_10_12_100000_create_password_reset_tokens_table',1),(3,'2019_08_19_000000_create_failed_jobs_table',1),(4,'2019_12_14_000001_create_personal_access_tokens_table',1),(5,'2023_03_14_094321_create_admins_table',1),(6,'2023_03_15_091028_create_sellers_table',1),(7,'2023_11_02_090331_create_modules_table',2),(8,'2023_11_02_090342_create_sub_modules_table',2),(9,'2023_11_02_015408_create_media_table',3),(14,'2023_10_07_021333_create_countries_table',5),(16,'2023_11_07_124245_create_service_sections_table',5),(17,'2023_11_07_124833_create_product_categories_table',5),(19,'2023_11_07_125258_create_product_sections_table',5),(20,'2023_11_02_095525_create_services_table',6),(23,'2023_10_17_073824_create_documents_table',8),(24,'2023_11_07_125145_create_products_table',9),(27,'2023_11_17_051410_create_notices_table',10),(28,'2023_11_17_051437_create_notice_maps_table',10),(29,'2023_11_17_071707_create_blog_categories_table',11),(30,'2023_11_17_071721_create_blogs_table',11),(31,'2023_11_17_085848_create_testimonials_table',12),(32,'2023_11_17_085901_create_clients_table',12);
...
INSERT INTO `modules` VALUES (1,'Files','fa-folders',1,8,NULL,NULL,NULL),(2,'Services','fa-file-certificate',1,1,NULL,NULL,NULL),(3,'Products','fa-boxes-stacked',1,2,NULL,NULL,NULL),(4,'Notices','fa-newspaper',1,3,NULL,NULL,NULL),(5,'Blogs','fa-blog',1,6,NULL,NULL,NULL),(6,'Clients','fa-users',1,7,NULL,NULL,NULL);
/*!40000 ALTER TABLE `modules` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `notice_maps`
--

DROP TABLE IF EXISTS `notice_maps`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `notice_maps` (
  `notice_map_id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `notice_id` bigint unsigned NOT NULL,
  `notice_product_id` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`notice_map_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `notice_maps`
--

LOCK TABLES `notice_maps` WRITE;
/*!40000 ALTER TABLE `notice_maps` DISABLE KEYS */;
/*!40000 ALTER TABLE `notice_maps` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `notices` (
  ...
  `media_id` bigint unsigned DEFAULT NULL,
  `img_alt` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `notice_content` text COLLATE utf8mb4_unicode_ci,
  `service_id` bigint unsigned DEFAULT NULL,
  `seo_title` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `seo_description` text COLLATE utf8mb4_unicode_ci,
  `seo_keywords` text COLLATE utf8mb4_unicode_ci,
  `notice_document` int NOT NULL DEFAULT '0',
  `notice_status` tinyint(1) NOT NULL DEFAULT '1',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`notice_id`),
  UNIQUE KEY `notices_notice_slug_unique` (`notice_slug`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `product_sections` VALUES (1,'Test','test','<p>test</p>',1,1,2,'2023-11-16 06:52:11','2023-11-16 06:52:11',NULL);
...
CREATE TABLE `products` (
  ...
  `media_id` bigint unsigned DEFAULT NULL,
  `img_alt` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `product_compliance` text COLLATE utf8mb4_unicode_ci,
...
INSERT INTO `products` VALUES (2,'Electronic games (video)','electronic-games-video',13,'Electronic games (video) - BIS/CRS Registration','IS Standard : IS 616:2010','<p><span lang=\"EN-GB\">Electronic games (video), as in video games, are a form of interactive entertainment that combines technology, storytelling, and gameplay. These games are generally played on electronic devices like computers, gaming consoles, and mobile devices, offering various genres and experiences, from action-packed adventures to strategic puzzles. Video games have become a significant part of popular culture, with a global audience that includes players of all ages. They offer immersive virtual worlds, rich narratives, and competitive or cooperative multiplayer experiences. The industry has seen constant innovation, with advancements in graphics, artificial intelligence, and virtual reality technology pushing the boundaries of what is possible in interactive entertainment. Video games are a source of entertainment and a platform for artistic expression, education, and even professional esports competitions. They continue to evolve and expand, connecting people worldwide through shared gaming experiences.</span></p>\r\n<p>&nbsp;</p>\r\n<p><span lang=\"EN-GB\">IS 616:2010 is an important standard in the realm of electronic games (video games). This Indian Standard sets guidelines and requirements for the design, production, and performance of electronic video games. IS 616:2010 provides a framework for ensuring the quality and reliability of electronic video games. Adhering to these standards helps manufacturers maintain a level of quality that meets or exceeds user expectations. This standard incorporates safety considerations, such as guidelines for avoiding content that could be harmful or inappropriate for certain age groups. Compliance with IS 616:2010 can help video game developers meet the necessary regulatory requirements, preventing legal issues and promoting consumer trust.</span></p>\r\n<p>&nbsp;</p>\r\n<p><strong><span lang=\"EN-GB\">Note: Foreign manufacturers of video games are required to obtain the mandatory BIS/CRS Registration to export their products in the Indian market.</span></strong></p>\r\n<p>&nbsp;</p>\r\n<p><span lang=\"EN-GB\">BIS/CRS Registration is a mandatory requirement for foreign manufacturers intending to export video games to India. This registration, mandated by the Indian government, is crucial to ensure that video games meet the country\'s specific technical and safety standards, thereby safeguarding the quality, content, and compliance with local regulations. Without BIS/CRS Registration, foreign manufacturers are legally restricted from marketing or distributing their video games in the Indian market. The registration process is meticulously designed to ensure that the imported video games adhere to stringent quality benchmarks, content guidelines, technical parameters, and safety requirements, contributing to a safe and entertaining gaming experience for Indian consumers.</span></p>',3,1,4,3,'Electronic games (video) - BIS/CRS Registration',NULL,NULL,1,0,'2023-11-16 05:44:09','2023-11-16 05:44:09',NULL),(3,'Test blog','test-blog',9,'Electronic games (video) - BIS/CRS Registration',NULL,NULL,NULL,NULL,NULL,NULL,'Test blog','Test blog','Test blog',1,0,'2023-11-17 03:06:17','2023-11-17 03:06:17',NULL);
...
INSERT INTO `sub_modules` VALUES (1,'1','Gallery','media.index',1,1,NULL,NULL,NULL),(2,'1','Documents','document.index',1,2,NULL,NULL,NULL),(3,'2','Services','services.index',1,1,NULL,NULL,NULL),(4,'3','Categories','products.categories.index',1,2,NULL,NULL,NULL),(5,'3','Products','products.index',1,1,NULL,NULL,NULL),(6,'4','All Notices','notices.index',1,1,NULL,NULL,NULL),(7,'5','Blog category','blogs.categories.index',1,2,NULL,NULL,NULL),(8,'5','Blogs','blogs.index',1,1,NULL,NULL,NULL),(9,'6','Testimonials','testimonials.index',1,2,NULL,NULL,NULL),(10,'6','Clients','clients.index',1,1,NULL,NULL,NULL);
...
CREATE TABLE `testimonials` (
  ...
  `testimonial_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `testimonial_slug` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `testimonial_designation` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `testimonial_company` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `media_id` bigint unsigned NOT NULL,
  `img_alt` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `testimonial_content` text COLLATE utf8mb4_unicode_ci,
  `testimonial_rating` int DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`testimonial_id`),
  UNIQUE KEY `testimonials_testimonial_slug_unique` (`testimonial_slug`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-11-20 10:38:43
