@extends('backend.layouts.app', ['module' => 'Blogs', 'title' => 'New Blog'])
@section('content')
<form class="form-horizontal" method="POST" action="{{route('blogs.store')}}" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="mb-3 col-md-6">
            ...
            <select class="form-control form-control-sm" id="blog_category_id" name="blog_category_id">
        ...
        <div class="mb-3 col-md-12">
            ...
            <textarea class="form-control form-control-sm text-editor" id="blog_content" name="blog_content"></textarea>
        </div>
        <div class="mb-3 col-md-12">
