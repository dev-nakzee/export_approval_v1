...
<form class="form-horizontal" method="POST" action="{{route('testimonials.store')}}" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="mb-3 col-md-6">
            ...
            <input type="text" class="form-control form-control-sm" id="testimonial_designation" name="testimonial_designation">
        </div>
        <div class="mb-3 col-md-6">
            <label for="testimonial_company" class="form-label">Testimonial company</label>
            <input type="text" class="form-control form-control-sm" id="testimonial_company" name="testimonial_company">
        </div>
        <div class="mb-3 col-md-12">
            <label for="testimonial_content" class="form-label">Testimonial content</label>
            <textarea class="form-control form-control-sm text-editor" id="testimonial_content" name="testimonial_content"></textarea>
        </div>
