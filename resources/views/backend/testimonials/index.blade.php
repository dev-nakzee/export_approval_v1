@extends('backend.layouts.app', ['module' => 'Testimonials', 'title' => 'All testimonials'])
@section('content')
<div>
    <div class="container-fluid row">
        <div class="col-md-12">
            ...
            @endif
            <a href="{{route('testimonials.create')}}" class="float-end btn btn-outline-primary btn-sm">
                <i class="fas fa-plus"></i>
            </a>
        </div>
        <div class="col-md-12 pt-1">
            <table class="table table-secondary table-bordered table-hover table-sm" id="testimonial-table">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Testimonials</th>
