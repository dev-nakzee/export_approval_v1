...
<form class="form-horizontal" method="POST" action="{{route('news.update', $news->news_id)}}" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="mb-3 col-md-6">
            ...
            <input type="text" class="form-control form-control-sm" id="name" name="name" value="{{$news->news_title}}">
        </div>
        <div class="mb-3 col-md-6">
            <label for="slug" class="form-label">News slug</label>
            <input type="text" class="form-control form-control-sm" id="slug" name="slug" value="{{$news->news_slug}}">
        </div>
        <div class="mb-3 col-md-6">
            <label for="media_id" class="form-label">News image</label>
        ...
        <div class="mb-3 col-md-6">
            <label for="slug" class="form-label">News image alt text</label>
            <input type="text" class="form-control form-control-sm" id="img_alt" name="img_alt" value="{{$news->img_alt}}">
        </div>
        <div class="mb-3 col-md-12">
            <label for="client_content" class="form-label">News Url</label>
            <input class="form-control form-control-sm text-editor" id="news_url" name="news_url" value={{$news->news_url}}>
        </div>
