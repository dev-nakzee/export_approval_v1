...
<form class="form-horizontal" method="POST" action="{{route('products.update', $product->product_id)}}" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="mb-3 col-md-6">
            ...
            <div class="input-group input-group-sm">
                <span class="input-group-text"><i class="fa-light fa-image"></i></span>
                <input type="text" class="form-control form-control-sm" id="infoDocument" disabled value="@if($infoDocument){{$infoDocument->document}}@endif">
                <input type="text" class="form-control form-control-sm" id="infoDocument_id" name="infoDocument_id" hidden value="@if($infoDocument){{$infoDocument->doc_id}}@endif">
        ...
        <div class="mb-3 col-md-6">
            ...
            <div class="input-group input-group-sm">
                <span class="input-group-text"><i class="fa-light fa-image"></i></span>
                <input type="text" class="form-control form-control-sm" id="guideDocument" disabled value="@if($guideDocument){{$guideDocument->document}}@endif">
                <input type="text" class="form-control form-control-sm" id="guideDocument_id" name="guideDocument_id" hidden value="@if($guideDocument){{$guideDocument->doc_id}}@endif">
