...
<form class="form-horizontal" method="POST" action="{{route('products.store')}}" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="mb-3 col-md-6">
            <label for="slug" class="form-label">Product Information</label>
            <input type="file" class="form-control form-control-sm" id="product_information" name="product_information">
        </div>
        <div class="mb-3 col-md-6">
            <label for="slug" class="form-label">Product Guidelines</label>
            <input type="file" class="form-control form-control-sm" id="product_guidelines" name="product_guidelines">
        </div>
        <div class="mb-3 col-md-12">
