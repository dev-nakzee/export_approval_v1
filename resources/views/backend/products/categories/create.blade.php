...
@section('content')
<form class="form-horizontal" method="POST" action="{{route('products.categories.store')}}">
    @csrf
    <div class="row">
        ...
        <div class="mb-3 col-md-12">
            ...
            <textarea class="form-control form-control-sm text-editor" id="product_category_content" name="product_category_content"></textarea>
        </div>
        <div class="mb-3 col-md-12">
