...
<form class="form-horizontal" method="POST" action="{{route('clients.update', $client->client_id)}}" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="mb-3 col-md-6">
            ...
            <input type="text" class="form-control form-control-sm" id="name" name="name" value="{{$client->client_name}}">
        </div>
        <div class="mb-3 col-md-6">
            <label for="slug" class="form-label">Client slug</label>
            <input type="text" class="form-control form-control-sm" id="slug" name="slug" value="{{$client->client_slug}}">
        </div>
        <div class="mb-3 col-md-6">
        ...
        <div class="mb-3 col-md-6">
            ...
            <input type="text" class="form-control form-control-sm" id="img_alt" name="img_alt" value="{{$client->img_alt}}">
        </div>
        <div class="mb-3 col-md-12">
            <label for="client_content" class="form-label">Client content</label>
            <textarea class="form-control form-control-sm text-editor" id="client_content" name="client_content">{{$client->client_content}}</textarea>
        </div>
