@extends('backend.layouts.app', ['module' => 'Notices', 'title' => 'All notices'])
@section('content')
<div>
    <div class="container-fluid row">
        <div class="col-md-12">
            ...
            @endif
            <a href="{{route('notices.create')}}" class="float-end btn btn-outline-primary btn-sm">
                <i class="fas fa-plus"></i>
            </a>
        </div>
        <div class="col-md-12 pt-1">
            <table class="table table-secondary table-bordered table-hover table-sm" id="notice-table">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Form</th>
...
<script>
    ...
    function noticeDatatable() {
        ...
        var table = $('#notice-table').DataTable({
            ...
            serverSide: true,
            responsive: true,
            ajax: "{{ route('notices.show') }}",
            columns: [
                {data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false},
                {data: 'form_name', name: 'form_name'},
                {data: 'form_email', name: 'form_email'},
