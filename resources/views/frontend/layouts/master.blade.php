            ...
            <div  class="uk-padding-large uk-padding-remove-vertical" uk-grid id="footer">
                ...
                <div class="uk-width-1-4@s">
                    <div uk-grid class="uk-margin-remove-top uk-margin-remove-left uk-margin-bottom uk-margin-remove-right">
                        ...
                        <p class="uk-width-4-5 uk-padding-remove uk-margin-remove uk-text-small"><strong>Brand Liaison India Pvt. Ltd.</strong><br>110, Sharma Complex<br> A-2, Guru Nanak Pura<br> Laxmi Nagar<br>
