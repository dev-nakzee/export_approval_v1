<html>
    ...
    <body>
        <nav style="border-bottom: 0.1em solid #e4e4e4;" class="uk-navbar-container uk-box-shadow-large uk-padding-large uk-padding-remove-vertical uk-background-transparent" uk-navbar="mode: click" uk-sticky="sel-target: .uk-navbar-container; cls-active: uk-navbar-sticky">
