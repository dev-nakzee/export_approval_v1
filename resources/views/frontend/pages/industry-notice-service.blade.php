...
@endsection
@section('content')
<h1 class="uk-hidden"> {{$page->page_name}} {{$notice_service->service_name}}</h1>
@if($agent->isMobile())
...
<section class="uk-section uk-padding-small">
    <div class="uk-text-center">
        <button class="uk-button uk-button-default uk-text-bolder" type="button" style="text-transform:capitalize !important;">Latest Notifications <span uk-drop-parent-icon></span></button>
        <div class="uk-card uk-card-body uk-card-default uk-text-bolder" uk-drop="mode: click; pos: bottom-center;">
