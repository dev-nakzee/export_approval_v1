...
@section('seo')
<title>{{$category_name->seo_title}}</title>
<meta name="keywords" content="{{$category_name->seo_keywords}}" />
<meta name="description" content="{{$category_name->seo_description}}" />
<meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1" />
<meta property="og:title" content="{{$category_name->page_name}}" />
<meta property="og:locale" content="en_US" />
<meta property="og:type" content="website" />
<meta property="og:description" content="{{$category_name->blog_category_name}}" />
...
@endsection
@section('content')
<h1 class="uk-hidden">{{$page->page_name}} - {{$category_name->blog_category_name}}</h1>
@if($agent->isMobile())
<section class="uk-section page-header uk-padding-small" uk-sticky="offset: 80">
    <div class="uk-text-center">
        <div>
            <img class="uk-margin-remove uk-border-circle mobile-page-image" src="{{asset('frontend/images/blog.webp')}}" alt="">
...
<section class="uk-section uk-padding-small uk-padding-remove-vertical">
    <div class="uk-padding-small">
        <ul class="uk-breadcrumb uk-text-center uk-margin-remove">
            ...
            <li><span> {{$category_name->blog_category_name}}</span></li>
        </ul>
    </div>
</section>
...
<section class="uk-section page-header uk-padding-small">
    <div class="uk-container uk-text-center">
        <div>
            <img class="uk-margin-right uk-border-circle service-details-image" src="{{asset('frontend/images/blog.webp')}}" alt="Blogs Image">
            <h2 class="uk-text-middle uk-inline uk-margin-remove">
            {{$page->page_name}}<br>
                <span class="uk-text-small" style="color: #8b8b8b;">{{$page->tagline}}</span>
            </h2>
            ...
            <div class="uk-width-1-4@m">
                <div class="ps-details-section">
                    <span class="uk-text-bold">
                        <img class="uk-border-circle title-page-image uk-margin-right" src="{{asset('frontend/images/blog.webp')}}" alt="Blog Image">
                        {{'Blog Categories'}}
                    </span>
