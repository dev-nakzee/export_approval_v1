            ...
            <div uk-grid>
                ...
                <div class="uk-width-1-2@m uk-margin-small">
                    <div class="uk-form-controls uk-padding uk-padding-remove-vertical uk-padding-remove-right" uk-grid>
                        ...
                        <input class="uk-input uk-width-expand uk-padding-small uk-padding-remove-vertical form-inputs" name="captcha" id="captcha" type="text" placeholder="Enter captcha value">
                    </div>
                </div>
                <div class="uk-width-1-2@m uk-margin-small">
