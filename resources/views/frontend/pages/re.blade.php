...
<section class="uk-section page-header uk-padding-small">
    <div class="uk-container uk-text-center">
        <div>
            <img class="uk-margin-remove uk-border-circle mobile-page-image" src="{{asset('frontend/images/handshake.webp')}}" alt="Partner with us Image">
...
<section class="uk-section uk-padding-small">
    <form method="POST" action="{{route('frontend.site.re.save')}}" id="partner_resident_form">
        @csrf    
        <div uk-grid>
            <legend class="uk-legend uk-width-1-1">Become a <strong>Resident Executive</strong> with us</legend>
            <div class="uk-margin-small uk-width-1-1 uk-section uk-padding-large uk-padding-remove-vertical uk-hidden" id="success-msg">
            ...
            <div class="uk-margin-small uk-width-1-2@m">
                <div class="uk-form-controls uk-padding uk-padding-remove-vertical uk-padding-remove-right" uk-grid>
                    <select class="uk-select uk-width-1-5 uk-padding-small uk-padding-remove-vertical form-inputs" id="salutation" {{old('salutation')}} name="salutation" style="font-size: 12px;">
                    ...
                    <input class="uk-input uk-width-4-5 uk-padding-small uk-padding-remove-vertical form-inputs" value="{{old('contact')}}" id="contact" name="contact" placeholder="Full name" aria-label="Input">
                </div>
            </div>
            <div class="uk-margin-small uk-width-1-2@m">
                <input class="uk-input form-inputs" type="text" placeholder="Field of expertise" aria-label="Input" id="expertise" name="expertise" value="{{old('expertise')}}">
            </div>
            <div class="uk-margin-small uk-width-1-1@m">
                <input class="uk-input form-inputs" type="text" placeholder="Complete address" aria-label="Input" id="address" name="address" value="{{old('address')}}">
            </div>
            <div class="uk-margin-small uk-width-1-2@m">
                <input class="uk-input form-inputs" type="text" placeholder="State / Province" aria-label="Input" id="state" name="state" value="{{old('state')}}">
            </div>
            <div class="uk-margin-small uk-width-1-2@m">
                <input class="uk-input form-inputs" type="text" placeholder="City / Town" aria-label="Input" id="city" name="city" value="{{old('city')}}">
            </div>
            <div class="uk-margin-small uk-width-1-2@m">
                <div class="uk-form-controls uk-padding uk-padding-remove-vertical uk-padding-remove-right" uk-grid>
                    <select class="uk-select uk-width-3-5 uk-padding-small uk-padding-remove-vertical form-inputs" id="country" name="country" value="{{old('country')}}">
                    ...
                    <input class="uk-input uk-width-2-5 uk-padding-small uk-padding-remove-vertical form-inputs" value="{{old('zip')}}" id="zip" name="zip" placeholder="Zip code" aria-label="Input">
                </div>
            </div>
            <div class="uk-margin-small uk-width-1-2@m">
                <div class="uk-form-controls uk-padding uk-padding-remove-vertical uk-padding-remove-right" uk-grid>
                    <select class="uk-select uk-width-2-5 uk-padding-small uk-padding-remove-vertical form-inputs" value="{{old('countrycode')}}" id="countrycode" name="countrycode" style="font-size: 12px;">
                    ...
                    <input class="uk-input uk-width-3-5 uk-padding-small uk-padding-remove-vertical form-inputs" value="{{old('phone')}}" id="phone" name="phone" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" id="mobile" type="text" placeholder="Phone number">
                </div>
            </div>
            <div class="uk-margin-small uk-width-1-2@m">
                <input class="uk-input form-inputs" type="email" placeholder="Email" aria-label="Input" name="email" id="email" value="{{old('email')}}">
            </div>
            <div class="uk-margin-small uk-width-1-2@m">
                <input class="uk-input form-inputs" type="text" placeholder="Years of experience" aria-label="Input" id="experience" name="experience" value="{{old('experience')}}">
            </div>
            <div class="uk-margin-small uk-width-1-1@m">
            ...
            <div class="uk-width-1-2@m uk-margin-small">
                <div class="uk-form-controls uk-padding uk-padding-remove-vertical uk-padding-remove-right" uk-grid>
                    ...
                    <canvas id="captcha_image" class="uk-padding-small uk-width-3-5 uk-padding-remove-vertical" width="120" height="25"></canvas>
                    ...
                    <input class="uk-input uk-width-1-1 uk-margin-small-top form-inputs uk-padding-small uk-padding-remove-vertical" name="captcha" id="captcha" type="text" placeholder="Enter captcha value">
                </div>
            </div>
            <div class="uk-width-1-2@m uk-margin-small">
...
<section class="uk-section page-header uk-padding-small">
    <div class="uk-container uk-text-center">
        <div>
            <img class="uk-margin-right uk-border-circle service-details-image" src="{{asset('frontend/images/handshake.webp')}}" alt="Partner with us Image">
            <h2 class="uk-text-middle uk-inline uk-margin-remove">
            {{$page->page_name}}<br>
                <span class="uk-text-small" style="color: #8b8b8b;">{{$page->tagline}}</span>
            </h2>
...
<script>
   ...
   $(document).on("submit", "#partner_resident_form", function(e) {
       e.preventDefault();
       formData = $('#partner_resident_form').serialize();
       ...
       if($('#salutation').val() === '') {
           ...
           $('#salutation').attr("placeholder", "Please enter full name");
           $error = 1;
       }
       if($('#contact').val() === '') {
       ...
       if($('#expertise').val() === '') {
           $('#expertise').addClass('form-error');
           $('#expertise').attr("placeholder", "Please enter an area of expertise");
           $error = 1;
       }
       if($('#address').val() === '') {
       ...
       if($('#experience').val() === '') {
           $('#experience').addClass('form-error');
