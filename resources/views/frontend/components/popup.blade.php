    ...
    <div class="uk-modal-dialog uk-modal-body uk-text-center">
        ...
        <div class="uk-child-width-1-2" uk-grid>
            <div class="uk-card-media-left uk-padding-large uk-padding-remove-horizontal" style="border-right: 1px solid #c9c9c9!important;">
                <h4 class="uk-h2 uk-text-bold site-blue">Welcome</h4>
                <h4 class="uk-h2 uk-text-bold site-blue">to</h4>
                <img class="uk-margin-top" style="height: 70px !important;" src="{{asset('frontend/images/logo.png')}}">
            </div>
            <div>
