    ...
    <div class="uk-width-1-2@m uk-width-1-1@s uk-modal-dialog uk-modal-body">
        ...
        <div class="uk-child-width-1-1">
            <div class="uk-padding@m uk-padding-small@s uk-text-center">
                ...
                <p class="uk-h4 uk-text-normal uk-text-justify">Dear Visitor,<br><br>You will find <span class="site-blue uk-text-bolder">Regulatory Product Compliance</span> solution here, <span class="site-orange uk-text-bolder">how to enable your product for Export to India?</span><br><br>We are looking forword to assist you further.</p>
