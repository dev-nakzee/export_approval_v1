                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="text-center registration_outer">
                                <div class="registration_logo">
                                    <img src="{{ url('front') }}/images/join_us_icon.png" alt="">
                                </div>
                                <h1>Joins Us</h1>
                            </div>
                        </div>
    ...
    <div class="container">
        <div class="row clearfix">
            ...
            <div class="info-column col-lg-5 col-md-12 col-sm-12">
                <div class="">
                    <div class="text-align-center join_us_img">
                        <img src="{{ url('front') }}/images/join-us-img.jpg" alt="">
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="enquiryrow2">
                                        ...
                                        <input type="hidden" name="enquiry_from" value="Join us form" id="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="enquiryrow2">
                                ...
                                <div class="col-md-6">
                                    <div class="enquiryrow2">
                                        <label>Country:</label>
                                        <select name="country" id="country" value="" autocomplete="on" data-parsley-required-message="Please Select Country"  required="" >
                                ...
                                <div class="col-md-12">
                                    <div class="enquiryrow2">
                                        <label>Comment</label>
                                        <textarea name="message" placeholder="Comment" name="message"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="enquiryrow2">
