        ...
        <div class="row">
                ...
                <div class="sticky-top unileftmenu">
                    <div class="sidebar">
                        <div class="sidebar-widget category-widget sidebar-widget2">
                            <h4>{{!empty($notificationData->title) ? $notificationData->title : '' }}</h4>
                            <div class="inner-box inner-box2">
                                <nav2>
                                    <ul class="product-category-list nav nav-pills nav-stacked sticky-sm-top"
                                        ...
                                        <li><a href="#section1" class="targetlink">
                                            {{!empty($catData->name) ? $catData->name : '' }}</a></li>
            ...
            <div class="col-md-8 col-lg-9">
                ...
                <div class="unisection section_bg section_bg2" style="position: relative;">
                    ...
                    <h3>{{ !empty($notificationData->title) ? $notificationData->title : '' }}</h3>
                    <!-- <h3></h3> -->
                    <p>{{ !empty($notificationData->subtitle) ? $notificationData->subtitle : '' }} </p>
                    {!! !empty($notificationData->description) ? $notificationData->description : '' !!}
